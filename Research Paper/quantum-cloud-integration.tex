...
% Title page setup
\newcommand{\mydegree}{Bachelor of Technology} % Replace with actual degree
\newcommand{\degreename}{Information Technology} % Replace with actual department
\newcommand{\mysupervisor}{Your Name} % Replace with your name or supervisor's name
...
\begin{center}
    ...
    {\begin{figure}[!h]
        \centering
        \includegraphics[width=40mm]{images\adypu.jpeg} % Replace with your college logo
    \end{figure}}
    \vspace{1.5\baselineskip}
...
% Continue with Challenges, Implications, Future Scope, Conclusion, and References
